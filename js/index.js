...
function srcListToThumbnails(srcList) {
  ...
  return srcList.map(projSrc => React.createElement('img', { 'data-src': 'holder.js/200x200', className: 'img-thumbnail', alt: '200x200', src: projSrc, 'data-holder-rendered': 'true', style: { display: "inline-block", height: "200px" } }));
}
...
ReactDOM.render(React.createElement(projectSection), document.getElementById('projectDiv'));
